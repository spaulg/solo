...
import (
	...
	container2 "github.com/spaulg/solo/internal/pkg/shared/infra/container"
)
...
func (t *DockerOrchestrator) ServicesStatus(serviceNames []string) (*container2.ServiceStatus, error) {
	arguments := []string{
		"compose",
	...
	return &container2.ServiceStatus{
