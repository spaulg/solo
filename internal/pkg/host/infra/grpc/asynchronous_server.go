...
func (t *AsynchronousServer) Start() error {
	...
	go func() {
		...
		serviceNameInterceptor := interceptors2.NewServiceNameInterceptor()
		containerNameInterceptor := interceptors2.NewContainerNameInterceptor(t.orchestrator)
		firstPreStartCompleteInterceptor := interceptors2.NewFirstContainerCompleteInterceptor(t.orchestrator)
