...
import (
	...
	service_definitions2 "github.com/spaulg/solo/internal/pkg/host/infra/grpc/service_definitions"
)
...
type MutualTLSServerFactory struct {
	...
	workflowRunner       service_definitions2.WorkflowRunner
}
...
func (t *MutualTLSServerFactory) Build(
	...
	workflowExecutionTracker service_definitions2.WorkflowExecTracker,
	project domain.Project,
	port int,
) (Server, error) {
	...
	workflowService := service_definitions2.NewWorkflowService(
		t.logger,
		t.project,
		orchestrator,
