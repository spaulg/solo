...
type ProjectControlTestSuite struct {
	...
	mockWorkflowExecTraceRepository *repository.MockJSONFileRepository[*domain2.WorkflowExecTrace]
}
...
func (t *ProjectControlTestSuite) SetupTest() {
	...
	t.mockAuditor = &audit.MockAuditor{}

	t.mockAuditor.On("RecordExecutionEvent", mock.AnythingOfType("func() error"))
	...
	t.mockWorkflowExecTraceRepository = &repository.MockJSONFileRepository[*domain2.WorkflowExecTrace]{}
	workflowExecTrace := domain2.NewWorkflowExecTrace()
