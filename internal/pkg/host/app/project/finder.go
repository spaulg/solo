...
func FindProject(startPath string, config *domain2.Config, profiles []string) (*domain2.Project, error) {
	...
	for {
		...
		if err != nil {
			...
			return domain2.NewProject(projectFilePath, config, profiles)
		}
	}
