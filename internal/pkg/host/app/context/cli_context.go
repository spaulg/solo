...
import (
	...
	"github.com/spaulg/solo/internal/pkg/host/infra/config"
	project_types "github.com/spaulg/solo/internal/pkg/shared/domain"
	logging2 "github.com/spaulg/solo/internal/pkg/shared/infra/logging"
)
...
func LoadCliContext() (*CliContext, error) {
	...
	context := &CliContext{
		...
		Logger:          slog.New(logging2.NewBlackHoleHandler()),
	...
	if configLoadErr == nil {
		...
		if context.Config.Logging.Enabled && context.Project != nil {
			...
			builder := logging2.NewLogHandlerBuilder()
			handler, err := builder.
