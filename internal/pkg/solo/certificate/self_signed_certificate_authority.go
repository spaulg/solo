...
func WithDuration(duration time.Duration) CertificateOption {
...
func WithExtKeyUsage(extKeyUsage []x509.ExtKeyUsage) CertificateOption {
	return func(template *x509.Certificate) {
		template.ExtKeyUsage = extKeyUsage
	}
}

func WithOrganization(organization []string) CertificateOption {
	return func(template *x509.Certificate) {
...
func NewCertificateAuthority() (Authority, error) {
...
func (t *SelfSignedCertificateAuthority) ExportCACertificate(project *project.Project) error {
