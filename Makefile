...
# Go build flags
LDFLAGS := -X 'github.com/spaulg/solo/internal/pkg/common/domain/version.Version=$(VERSION)' \
           -X 'github.com/spaulg/solo/internal/pkg/common/domain/version.GitCommit=$(GIT_COMMIT)' \
           -X 'github.com/spaulg/solo/internal/pkg/common/domain/version.BuildDate=$(BUILD_DATE)'
...
protos:
	...
	find $(SRC_DIR)/internal/pkg/common/infra/grpc/services -name *.proto -exec \
